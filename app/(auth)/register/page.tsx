    ...
    <div className="flex flex-1">
      ...
      <div className="flex-1 hidden lg:block relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          <div className="absolute top-[20%] right-[20%] w-32 h-32 rounded-full border border-amber-200/20 animate-float" />
          <div
            className="absolute bottom-[20%] left-[20%] w-40 h-40 rounded-full border border-amber-200/10 animate-float"
            style={{ animationDelay: "-2s" }}
          />
          <div
            className="absolute top-[50%] left-[50%] w-48 h-48 rounded-full border border-amber-200/5 animate-float"
